...
class _JsonTypeInferrer(_TypeInferrer):
    ...
    def infer(self) -> str:
        inferred_types = None  # Using 'None' to handle initial intersection case
        ...
        for value in self._values:
            ...
            if self._NULL_TYPE not in types:
                ...
                if inferred_types is None:
                    ...
                    inferred_types &= types  # Perform intersection directly
        ...
        if inferred_types is None:
            inferred_types = set()  # Initialize as empty set if all were null

        if self._BOOLEAN_TYPE in inferred_types:
            return self._BOOLEAN_TYPE
        elif self._INTEGER_TYPE in inferred_types:
            return self._INTEGER_TYPE
        elif self._NUMBER_TYPE in inferred_types:
