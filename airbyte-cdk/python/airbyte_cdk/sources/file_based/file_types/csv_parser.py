...
class CsvParser(FileTypeParser):
    ...
    def _to_nullable(
        ...
        deduped_property_types_get = deduped_property_types.get
        _value_is_none = CsvParser._value_is_none

        nullable = {
            k: None if _value_is_none(v, deduped_property_types_get(k), null_values, strings_can_be_null) else v for k, v in row.items()
        }
        return nullable
